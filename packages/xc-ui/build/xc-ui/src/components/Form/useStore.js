...
function fieldsReducer(state, action) {
    ...
    switch (action.type) {
        case 'addField':
            return __assign(__assign({}, state), (_a = {}, _a[action.name] = {
                name: action.name,
                value: action.value,
                type: 'text',
                rules: action.rules,
        ...
        case 'validateField':
            return __assign(__assign({}, state), (_c = {}, _c[action.name] = __assign(__assign({}, state[action.name]), { isValid: action.isValid, errors: action.errors }), _c));
        default:
            return state;
    }
}
function useStore() {
    ...
    var _b = React.useReducer(fieldsReducer, {}), fields = _b[0], dispatch = _b[1];
    var getFieldValue = function (name) { return fields[name] && fields[name].value; };
    // 转换函数
    ...
    var validateField = function (name) { return __awaiter(_this, void 0, void 0, function () {
        var _a, value, rules, afterTransformRules, decriptor, valueMap, validator, isValid, errors, e_1, err;
        var _b, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    afterTransformRules = transformRules(rules);
                    decriptor = (_b = {}, _b[name] = afterTransformRules, _b);
                    valueMap = (_c = {}, _c[name] = value, _c);
                    validator = new Schema(decriptor);
                    isValid = true;
                    errors = [];
                    _d.label = 1;
                case 1:
                ...
                case 4:
                    ...
                    dispatch({ type: 'validateField', name: name, isValid: isValid, errors: errors });
                    return [7 /*endfinally*/];
                case 5: return [2 /*return*/];
            }
        });
    }); };
    var validateForm = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    descriptor = mapValues(fields, function (field) {
